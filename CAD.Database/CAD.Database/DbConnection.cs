...
{
    //adapted from https://github.com/ericdc1/Dapper.SimpleCRUD
    ...
    public class DbConnection : IDisposable
    {
        ...
        /// <param name="tableName">Leave this parameter null unless you really need to set the table name programatically.
        /// If left null, the table name will be pulled from the table name attribute or, if not set, the type of the object.</param>
        /// <param name="defaultCommandTimeout"></param>
        public DbConnection(IDbConnection conn, string tableName = null, int defaultCommandTimeout = 60)
        {
            Conn = conn;
            ConfigureConnectionTypeSettings(conn.GetType());
        ...
        /// <summary>
        /// Configures settings based on connection type.
        /// </summary>
        /// <param name="dbConnectionType"></param>
        public void ConfigureConnectionTypeSettings(Type dbConnectionType)
        {
            switch (dbConnectionType.Name) {
                case "SqlConnection":
                    _encapsulation = "[{0}]";
        ...
        public virtual Task<IEnumerable<T>> GetCollectionAsync<T>(string query, object parameters = null, int? commandTimeout = null)
        {
        ...
        /// <para>whereObject is an anonymous type to filter the results ex: new {Category = 1, SubCategory=2}</para>
        /// <para>query should be left null. This parameter is only there to prevent overloading signature duplication. Use another overload if query is needed.</para>
        ...
        public virtual Task<T> GetAsync<T>(object whereObject, string query = null, int? commandTimeout = null)
        {
            ...
            return Conn.QueryFirstOrDefaultAsync<T>(sb.ToString(), whereObject, commandTimeout: commandTimeout ?? _defaultCommandTimeout,
                transaction: _transaction);
        }
        ...
        public virtual Task<T> GetAsync<T>(object id, int? commandTimeout = null)
        {
            ...
            return Conn.QueryFirstOrDefaultAsync<T>(sb.ToString(), parameters,
                commandTimeout: commandTimeout ?? _defaultCommandTimeout, transaction: _transaction);
        }
        ...
        /// <returns>Gets a list of entities with optional exact match where conditions</returns>
        public virtual Task<IEnumerable<T>> GetAllAsync<T>(object whereObject = null, int? commandTimeout = null,
            CommandType commandType = CommandType.Text)
        {
            ...
            return Conn.QueryAsync<T>(sb.ToString(), whereObject, commandTimeout: commandTimeout ?? _defaultCommandTimeout,
                transaction: _transaction, commandType: commandType);
        }

        public virtual Task<IEnumerable<T>> GetAllAsync<T>(string query, object parameters = null, int? commandTimeout = null,
            CommandType commandType = CommandType.Text)
        {
            return Conn.QueryAsync<T>(query, parameters, commandTimeout: commandTimeout ?? _defaultCommandTimeout,
                transaction: _transaction, commandType: commandType);
        }
        ...
        public virtual Task<IEnumerable<T>> GetAllPagedAsync<T>(int pageNumber, int rowsPerPage,
            string conditions,
        ...
        public virtual async Task<TKey> InsertAsync<TKey, TEntity>(TEntity entityToInsert, int? commandTimeout = null)
        {
            ...
            if (keyType == typeof(Guid) || keyHasPredefinedValue) {
                await Conn.ExecuteAsync(sb.ToString(), entityToInsert,
                    commandTimeout: commandTimeout ?? _defaultCommandTimeout, transaction: _transaction);
                return (TKey) idProps.First().GetValue(entityToInsert, null);
            }

            var result = await Conn.QueryAsync(sb.ToString(), entityToInsert,
                commandTimeout: commandTimeout ?? _defaultCommandTimeout, transaction: _transaction);
            return (TKey) result.First().id;
        }

        public virtual async Task<bool> BulkInsert<T>(IEnumerable<T> entitiesToInsert) where T : class
        {
            var bulk = new BulkOperations();

            bulk.Setup<T>(x => x.ForCollection(entitiesToInsert))
                .WithTable(GetTableName(typeof(T)))
                .AddAllColumns()
                .BulkInsert();

            await bulk.CommitTransactionAsync((SqlConnection) Conn);
            return true;
        }

        public virtual bool BulkMerge<T>(IEnumerable<T> entitiesToMerge) where T : class
        {
            //Conn.BulkMerge(entitiesToMerge);
            return true;
        }

        public virtual bool BulkMerge<T>(string mapperKey, IEnumerable<T> entitiesToMerge) where T : class
        {
            //Conn.BulkInsert(mapperKey, entitiesToMerge);
            return true;
        }
        ...
        public virtual Task<int> UpdateAsync<T>(T entityToUpdate, int? commandTimeout = null)
        {
            ...
            return Conn.ExecuteAsync(sb.ToString(), entityToUpdate, commandTimeout: commandTimeout ?? _defaultCommandTimeout,
                transaction: _transaction);
        }
        ...
        public virtual Task<int> DeleteAsync<T>(T entityToDelete, int? commandTimeout = null)
        {
            ...
            return Conn.ExecuteAsync(sb.ToString(), entityToDelete, commandTimeout: commandTimeout ?? _defaultCommandTimeout,
                transaction: _transaction);
        }
        ...
        public virtual Task<int> DeleteAsync<T>(object id, int? commandTimeout = null)
        {
            ...
            return Conn.ExecuteAsync(sb.ToString(), parameters, commandTimeout: commandTimeout ?? _defaultCommandTimeout,
                transaction: _transaction);
        }
        ...
        public virtual Task<int> DeleteCollectionAsync<T>(object whereConditions, int? commandTimeout = null)
        {
            ...
            return Conn.ExecuteAsync(sb.ToString(), whereConditions, commandTimeout: commandTimeout ?? _defaultCommandTimeout,
                transaction: _transaction);
        }
        ...
        {
            return Conn.ExecuteAsync(query, parameters, commandTimeout: commandTimeout ?? _defaultCommandTimeout,
                transaction: _transaction);
        }
            ...
            int? commandTimeout = null)
        {
            ...
            return Conn.ExecuteScalarAsync<int>(sb.ToString(), parameters, commandTimeout: commandTimeout ?? _defaultCommandTimeout,
                transaction: _transaction);
        }
        ...
        public virtual Task<int> GetRecordCountAsync<T>(object whereConditions, int? commandTimeout = null)
        {
            ...
            return Conn.ExecuteScalarAsync<int>(sb.ToString(), whereConditions,
                commandTimeout: commandTimeout ?? _defaultCommandTimeout, transaction: _transaction);
        }
        ...
        public string GetTableName(Type type)
        {
            if (!string.IsNullOrEmpty(_tableName)) {
                _tableNames.AddOrUpdate(type, _tableName, (t, v) => _tableName);
                return _tableName;
            }
        ...
        private string GetColumnName(PropertyInfo propertyInfo)
        {
            ...
            if (_columnNames.TryGetValue(key, out string columnName))
                return columnName;
        ...
        public string Encapsulate(string word)
        {
            return string.Format(_encapsulation, word);
        }
        ...
        public class TableNameResolver : ITableNameResolver
        {
            ...
            public virtual string ResolveTableName(Type type)
            {
                ...
                if (tableAttribute == null) return tableName;
                
                tableName = Encapsulate(tableAttribute.Name);
                try {
                    if (!string.IsNullOrEmpty(tableAttribute.Schema)) {
                        string schemaName = Encapsulate(tableAttribute.Schema);
            ...
            private string Encapsulate(string word)
            {
                return string.Format(_encapsulation, word);
            }
        }
        ...
        public class ColumnNameResolver : IColumnNameResolver
        {
            ...
            public virtual string ResolveColumnName(PropertyInfo propertyInfo)
            {
                ...
                var columnAttribute = propertyInfo.GetCustomAttributes(true)
                    .SingleOrDefault(attr => attr.GetType().Name == typeof(ColumnAttribute).Name) as dynamic;
                if (columnAttribute != null) {
                    columnName = Encapsulate(columnAttribute.Name);
