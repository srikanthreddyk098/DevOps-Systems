...
namespace CAD.Database.Bulk
{
    ...
    public class ColumnSelect<T>
    {
        ...
        /// </summary>
        /// <returns></returns>
        public BulkMerge<T> BulkInsertOrUpdate()
        {
        ...
        {
            return new BulkDelete<T>(_list, _tableName, _schema, _columns, _disableIndexList, _disableAllIndexes, _sourceAlias, _targetAlias,
