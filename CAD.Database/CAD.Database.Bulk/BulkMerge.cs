...
namespace CAD.Database.Bulk
{
    ...
    public class BulkMerge<T> : ITransaction
    {
        ...
        public BulkMerge(IEnumerable<T> list, string tableName, string schema, HashSet<string> columns, HashSet<string> disableIndexList,
            bool disableAllIndexes, string sourceAlias, string targetAlias,
