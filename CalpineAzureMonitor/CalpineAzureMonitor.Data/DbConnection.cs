...
namespace CalpineAzureMonitor.Data
{
    ...
    public class DbConnection : IDbConnection
    {
        ...
        //private static int DefaultCommandTimeout => int.TryParse(ConfigurationManager.AppSettings["commandTimeoutInSeconds"], out var timeout) ? timeout : 60;
        ...
        public virtual Task ExecuteStoredProcedureAsync(string storedProcedureName, object parameters = null, int? commandTimeout = null)
        {
            return _conn.QueryAsync(storedProcedureName, parameters, _transaction, commandTimeout, CommandType.StoredProcedure);
        }
